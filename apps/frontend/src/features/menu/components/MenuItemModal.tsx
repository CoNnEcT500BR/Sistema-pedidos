      ...
      <DialogContent className="max-h-[90vh] overflow-y-auto p-0 sm:max-w-lg">
        ...
        <DialogHeader className="sticky top-0 z-10 border-b border-gray-100 bg-white px-6 py-4">
          ...
          <DialogDescription className="sr-only">
            Modal de personalizacao do item {item.name}. Ajuste ingredientes e quantidade antes de adicionar ao carrinho.
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="flex flex-col gap-5 px-6 pb-6 pt-4">
          ...
          {mustSelectFlavor && !hasSelectedFlavor && (
            <p className="rounded-xl border border-red-200 bg-red-50 px-3 py-2 text-sm text-red-600">
              Escolha obrigatoriamente um sabor para a bebida.
            </p>
          )}

          {/* Quantidade */}
          <div className="flex items-center justify-between">
            <span className="text-base font-semibold text-gray-700">Quantidade</span>
            <div className="flex items-center gap-4">
              <button
          ...
          >
            <span className="text-lg font-bold">Adicionar ao Carrinho</span>
