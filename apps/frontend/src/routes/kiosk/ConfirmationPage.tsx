...
export function ConfirmationPage() {
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-gradient-to-br from-green-50 to-emerald-100 px-6 text-center">
      ...
      {/* Número do pedido */}
      <h1 className="mb-2 text-2xl font-bold text-gray-700">Pedido realizado com sucesso!</h1>
      <p className="mb-6 text-base text-gray-500">Anote seu número e aguarde a chamada</p>
      ...
      <p className="mt-6 text-sm text-gray-400">
        Redirecionando automaticamente em {AUTO_REDIRECT_MS / 1000}s...
      </p>
    </div>
  );
}
